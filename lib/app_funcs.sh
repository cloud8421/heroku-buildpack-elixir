...
function write_profile_d_script() {
  ...
  local export_line="export PATH=\$HOME/.platform_tools:\$HOME/.platform_tools/erlang/bin:\$HOME/.platform_tools/elixir/bin:\$HOME/.platform_tools/goon:\$HOME/bin:\$PATH
